...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.site.hero','data' => ['title' => $page?->hero_title ?? $page?->title ?? 'Actualités','subtitle' => $page?->hero_subtitle ?? $page?->excerpt ?? 'Les contenus récurrents publiés depuis l’admin.','image' => $page?->heroImageUrl()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page?->hero_title ?? $page?->title ?? 'Actualités'),'subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page?->hero_subtitle ?? $page?->excerpt ?? 'Les contenus récurrents publiés depuis l’admin.'),'image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page?->heroImageUrl())]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.site.grid','data' => ['columns' => '3','class' => 'news-list']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['columns' => '3','class' => 'news-list']); ?>
...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->title),'url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->hasDetailPage() ? route('news.show', $post->slug) : null)]); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->is_pinned): ?>
                        <?php if (isset($component)) { $__componentOriginal9667f7efe997057dc88ad60450f89dbf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9667f7efe997057dc88ad60450f89dbf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.site.badge','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('site.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Épinglé <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9667f7efe997057dc88ad60450f89dbf)): ?>
<?php $attributes = $__attributesOriginal9667f7efe997057dc88ad60450f89dbf; ?>
<?php unset($__attributesOriginal9667f7efe997057dc88ad60450f89dbf); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal9667f7efe997057dc88ad60450f89dbf)): ?>
<?php $component = $__componentOriginal9667f7efe997057dc88ad60450f89dbf; ?>
<?php unset($__componentOriginal9667f7efe997057dc88ad60450f89dbf); ?>
<?php endif; ?>
...
], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ivocorreiademelo/Sites/avocat-cms/resources/views/site/news/index.blade.php ENDPATH**/ ?>